...
bool RenderWindow::Initialize(WindowContainer* pWindowContainer, HINSTANCE hIsntance, std::string window_title, std::string window_class, int width, int height)
{
